    ...
    <div>
      ...
      <div className='prompt-container'>
        <div className='prompt-textarea-container'>
          <textarea ref={textareaRef} value={userInput + allText} rows="1" className='prompt-textarea-box' onChange={(e) => setUserInput(e.target.value)} onKeyDown={handleSendMessage} placeholder="Thype Prompt Here..." onInput={handleTextAreaHeight} style={{height: 72px}}></textarea>
        </div>
      </div>
    </div>
  );
